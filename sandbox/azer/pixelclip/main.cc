...
::base::FilePath vertex_shader_path(TEXT("sandbox/azer/pixelclip/vs.hlsl"));
::base::FilePath pixel_shader_path(TEXT("sandbox/azer/pixelclip/ps.hlsl"));
...
void MainDelegate::Init() {
  ...
  tex_.reset(rs->CreateTextureFromFile(
      azer::Texture::k2D, base::FilePath(TEXT("sandbox/azer/media/Cage.png"))));
