...
::base::FilePath vertex_shader_path(TEXT("sandbox/azer/wvp/vs.hlsl"));
::base::FilePath pixel_shader_path(TEXT("sandbox/azer/wvp/ps.hlsl"));
...
void MainDelegate::Init() {
  ...
  azer::Vector3 camPosition( 0.0f, -0.5f, 2.0f);
...
void MainDelegate::OnRenderScene(double time, float delta_time) {
  ...
  azer::Matrix4 wvp = camProjection * camView;
