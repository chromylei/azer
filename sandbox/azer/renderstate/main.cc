...
::base::FilePath vertex_shader_path(TEXT("sandbox/azer/renderstate/vs.hlsl"));
::base::FilePath pixel_shader_path(TEXT("sandbox/azer/renderstate/ps.hlsl"));
...
void MainDelegate::Init() {
  ...
  //Camera information
  azer::Vector3 camPosition( 0.0f, 3.0f, -20.0f);
  ...
  rs->SetFrontFace(azer::kClockwise);
