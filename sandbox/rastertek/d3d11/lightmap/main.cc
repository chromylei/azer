...
#define EFFECT_GEN_DIR "out/dbg/gen/sandbox/rastertek/d3d11/lightmap/"
#define SHADER_NAME "lightmap"
using base::FilePath;
 ...
 public:
  ...
  void Init() {
    ...
    tex2_.reset(rs->CreateTextureFromFile(
        azer::Texture::k2D,
        base::FilePath(TEXT("sandbox/rastertek/media/light01.dds"))));
