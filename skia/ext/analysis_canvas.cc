...
void AnalysisCanvas::clipRect(const SkRect& rect, SkRegion::Op op, bool do_aa) {
  return INHERITED::clipRect(rect, op, do_aa);
}

void AnalysisCanvas::clipPath(const SkPath& path, SkRegion::Op op, bool do_aa) {
...
void AnalysisCanvas::clipRRect(const SkRRect& rrect,
                               SkRegion::Op op,
                               bool do_aa) {
